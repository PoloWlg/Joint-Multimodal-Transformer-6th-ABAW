...
class ImageList_test(data.Dataset):
	def __init__(self, root, fileList, audList, length, flag, stride, dilation,
		...
		self.sequence_list = seq_reader(self.videoslist, self.win_length,
										self.stride, self.dilation,
										self.wavs_list, realtimestamps_path)
		#self.stride = stride
	...
	def __getitem__(self, index):
		...
		return seq, aud_data, fr_ids, video, vid_lengths, wav_file  # _index
